   ...
   <input type="hidden" name="id" value="${user['id'] }"/>
	   <table class="table table-bordered" >
	     <tr>
	       ...
	       <td colspan="3"><input type="text" name="account" id="account" value="${user['account'] }"/></td>
	     </tr>
	     <tr>
	       <td nowrap="nowrap">密码：</td>
	       <td colspan="3"><input type="text" name="password" id="password" value="${user['password'] }"/></td>
	     </tr>
	     <tr>
	       <td nowrap="nowrap">电话：</td>
	       <td colspan="3"><input type="text" name="tel" id="tel" value="${user['tel'] }"/></td>
	     </tr>
	     <tr>
	       <td nowrap="nowrap">邮箱：</td>
	       <td colspan="3"><input type="text" name="email" id="email" value="${user['email'] }"/></td>
	     </tr>
	     <tr>
	      ...
	      <table  class="margin-bottom-20 table  no-border" >
	        <tr>
	     	<td class="text-center"><input type="submit" value="提交" class="btn btn-info " onclick="alert('修改成功')" style="width:80px;" /></td>
	     </tr>
	 </table>
   </form>
   </div>  
