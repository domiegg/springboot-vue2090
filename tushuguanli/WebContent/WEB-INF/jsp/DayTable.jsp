...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="image/image/tbg.gif">&nbsp;日常打卡&nbsp;</td>
</tr>
...
<c:forEach items="${pager.datas }" var="day" varStatus="vs">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td>${day['adminName'] }</td>
	<td>${day['time'] }</td>
</tr>
...
<tr align="right" bgcolor="#EEF4EA">
	...
	<c:if test="${pager.pageNow gt 1}">
                <a href="sys/day/query?pageNow=${pager.pageNow-1 }">上一页</a>
                </c:if>
                <c:if test="${pager.pageNow lt pager.totalPage}">
                <a href="sys/day/query?pageNow=${pager.pageNow+1 }">下一页</a>
                </c:if>
	</td>
</tr>
</table>
