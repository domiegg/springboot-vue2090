...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="image/image/tbg.gif">&nbsp;期刊管理&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><a href="sys/magazine/Edit?id=${magazine['id'] }">编辑</a> | <a href="sys/magazine/delete?id=${magazine['id'] }" onclick="return DCheck();">报废</a></td>
</tr>
</c:forEach>
