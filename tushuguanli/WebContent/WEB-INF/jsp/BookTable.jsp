...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="image/image/tbg.gif">&nbsp;我要借书&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><a href="sys/rent/add?bookName=${book['bookName'] }&bookNumber=${book['bookNumber']}&customName=${sessionScope['User']['account']}&bookId=${book['id']}" onclick="return check(${book['bookNumber']});">借书</a> | <a href="sys/book/queryOne?id=${book['id'] }">查看</a></td>
</tr>
</c:forEach>
