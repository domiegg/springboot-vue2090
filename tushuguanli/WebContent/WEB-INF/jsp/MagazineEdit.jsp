...
<div id="middle">
   ...
   <div class="title_right"><strong>期刊资料</strong></div>
   <div style="width:900px; margin:auto">
   <form action="sys/magazine/update" method="post" onsubmit="return check();">
   <input type="hidden" name="id" value="${magazine['id'] }"/>
	   <table class="table table-bordered" >
	     <tr>
	       <td nowrap="nowrap">期刊名称：</td>
	       <td colspan="3"><input type="text" name="bookName" id="bookName" value="${magazine['bookName'] }"/></td>
	     </tr>
	     <tr>
	       <td nowrap="nowrap">期刊类型：</td>
	       <td colspan="3">
		       <select name="bookType" id="bookType">
		       		<c:forEach items="${type }" var="t">
		       			<c:if test="${magazine['bookType'] eq t['typeName'] }" var="s1">
	     ...
	     <tr>
	       <td nowrap="nowrap">期刊作者：</td>
	       <td colspan="3"><input type="text" name="bookWriter" id="bookWriter" value="${magazine['bookWriter'] }"/></td>
	     </tr>
	     <tr>
	       <td nowrap="nowrap">出版社：</td>
	       <td colspan="3"><input type="text" name="bookHouse" id="bookHouse" value="${magazine['bookHouse'] }"/></td>
	     </tr>
	     <tr>
	       <td nowrap="nowrap">库存：</td>
	       <td colspan="3"><input type="text" name="bookNumber" id="bookNumber" value="${magazine['bookNumber'] }"/></td>
	     </tr>
	   </table>
